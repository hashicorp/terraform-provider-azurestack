...
func TestAccDnsCNameRecord_withAlias(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurestack_dns_cname_record", "test")
	r := DnsCNameRecordResource{}
	targetResourceName := "azurestack_dns_cname_record.target"
	targetResourceName2 := "azurestack_dns_cname_record.target2"
...
func TestAccDnsCNameRecord_RecordToAlias(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurestack_dns_cname_record", "test")
	r := DnsCNameRecordResource{}
	targetResourceName := "azurestack_dns_cname_record.target2"
...
resource "azurestack_dns_cname_record" "target" {
...
resource "azurestack_dns_cname_record" "test" {
  ...
  zone_name           = azurestack_dns_zone.test.name
  ttl                 = 300
  target_resource_id  = azurestack_dns_cname_record.target.id
}
...
resource "azurestack_dns_cname_record" "target2" {
...
resource "azurestack_dns_cname_record" "test" {
  ...
  zone_name           = azurestack_dns_zone.test.name
  ttl                 = 300
  target_resource_id  = azurestack_dns_cname_record.target2.id
}
`, data.RandomInteger, data.Locations.Primary, data.RandomInteger, data.RandomInteger, data.RandomInteger)
}
