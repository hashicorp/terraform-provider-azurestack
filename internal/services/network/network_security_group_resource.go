...
func networkSecurityGroup() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		Create: networkSecurityGroupCreateUpdate,
		Read:   networkSecurityGroupRead,
		Update: networkSecurityGroupCreateUpdate,
		Delete: networkSecurityGroupDelete,
...
func networkSecurityGroupCreateUpdate(d *pluginsdk.ResourceData, meta interface{}) error {
	...
	if d.IsNewResource() {
		...
		if existing.ID != nil && *existing.ID != "" {
			return tf.ImportAsExistsError("azurestack_network_security_group", *existing.ID)
		}
	}
...
func networkSecurityGroupRead(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Network.SecurityGroupClient
...
func networkSecurityGroupDelete(d *pluginsdk.ResourceData, meta interface{}) error {
	client := meta.(*clients.Client).Network.SecurityGroupClient
...
func expandazurestackSecurityRules(d *pluginsdk.ResourceData) ([]network.SecurityRule, error) {
