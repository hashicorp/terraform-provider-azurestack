...
import (
	...
	"github.com/terraform-providers/terraform-provider-azurestack/azurestack/internal/services/media/parse"
	"github.com/terraform-providers/terraform-provider-azurestack/azurestack/internal/services/media/validate"
