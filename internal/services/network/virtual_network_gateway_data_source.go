...
func virtualNetworkGatewayDataSource() *pluginsdk.Resource {
	return &pluginsdk.Resource{
		Read: virtualNetworkGatewayDataSourceRead,
...
func virtualNetworkGatewayDataSourceRead(d *pluginsdk.ResourceData, meta interface{}) error {
