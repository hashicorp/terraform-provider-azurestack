...
func TestAccLoadBalancerNatPool_basic(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurestack_lb_nat_pool", "test")
...
func TestAccLoadBalancerNatPool_complete(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurestack_lb_nat_pool", "test")
	r := LoadBalancerNatPool{}
...
func TestAccLoadBalancerNatPool_update(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurestack_lb_nat_pool", "test")
	r := LoadBalancerNatPool{}
...
func TestAccLoadBalancerNatPool_requiresImport(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurestack_lb_nat_pool", "test")
	r := LoadBalancerNatPool{}
...
func TestAccLoadBalancerNatPool_disappears(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurestack_lb_nat_pool", "test")
	r := LoadBalancerNatPool{}
...
func TestAccLoadBalancerNatPool_updateMultiplePools(t *testing.T) {
	data := acceptance.BuildTestData(t, "azurestack_lb_nat_pool", "test")
	data2 := acceptance.BuildTestData(t, "azurestack_lb_nat_pool", "test2")
...
resource "azurestack_lb_nat_pool" "import" {
  name                           = azurestack_lb_nat_pool.test.name
  loadbalancer_id                = azurestack_lb_nat_pool.test.loadbalancer_id
  resource_group_name            = azurestack_lb_nat_pool.test.resource_group_name
  frontend_ip_configuration_name = azurestack_lb_nat_pool.test.frontend_ip_configuration_name
  protocol                       = "Tcp"
  frontend_port_start            = 80
  frontend_port_end              = 81
  backend_port                   = 3389
