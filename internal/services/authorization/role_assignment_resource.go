...
import (
	...
	managementGroupValidate "github.com/hashicorp/terraform-provider-azurestack/internal/services/managementgroup/validate"
	resourceValidate "github.com/hashicorp/terraform-provider-azurestack/internal/services/resource/validate"
	subscriptionValidate "github.com/hashicorp/terraform-provider-azurestack/internal/services/subscription/validate"
...
func resourceArmRoleAssignmentCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if existing.ID != nil && *existing.ID != "" {
		return tf.ImportAsExistsError("azurestack_role_assignment", *existing.ID)
	}
	...
	if err := resource.RetryContext(ctx, d.Timeout(schema.TimeoutCreate), retryRoleAssignmentsClient(d, scope, name, properties, meta)); err != nil {
		return err
	}
