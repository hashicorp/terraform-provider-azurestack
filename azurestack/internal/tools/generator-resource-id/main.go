...
func (id ResourceIdGenerator) TestCode() string {
	...
	if id.TestPackageSuffix != "" {
		importLine = fmt.Sprintf("\"github.com/terraform-providers/terraform-provider-azurestack/azurestack/internal/services/%s/parse\"", id.ServicePackageName)
	}
...
import (
	...
	"github.com/terraform-providers/terraform-provider-azurestack/azurestack/internal/services/%[2]s/parse"
)
...
import (
	...
	"github.com/terraform-providers/terraform-provider-azurestack/azurestack/internal/services/%[4]s/validate"
)
